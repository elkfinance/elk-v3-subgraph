...
export const WETH_ADDRESS = 'replace_wethaddress'
export const USDC_WETH_03_POOL = 'replace_stableNativePool'
export const STABLECOIN_IS_TOKEN0 = replace_boolean
