...
export function getSubgraphConfig(): SubgraphConfig {
  ...
  if (selectedNetwork == MATIC_NETWORK_NAME) {
    return {
      factoryAddress: '0xc05a5aa56df0dc97d6b9849a06627a079790014f',
      stablecoinWrappedNativePoolAddress: '0x8269e9b5ea41094a7f546148a4b8cf79ab7b3f93', // WETH-USDC 0.05% pool
      stablecoinIsToken0: false,
      wrappedNativeAddress: '0x0d500b1d8e8ef31e21c99d1db9a6444d3adf1270', // WETH
